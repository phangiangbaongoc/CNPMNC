...
const Dashboard = () => {
  ...
  const topProducts = [
    {
      photo:
        "https://cdn.tuoitre.vn/thumb_w/586/2022/8/1/photo-3-16593440747491567009046-1659344316464156375039.png",
      nameStore: "Bún Bò",
      quantity: 120,
      revenue: "1.300.000đ",
    },
    {
      photo:
        "https://i.pinimg.com/736x/e7/d3/3d/e7d33d3f552b1fcb6f941a222a99d842.jpg",
      nameStore: "Bún Đậu",
      quantity: 85,
      revenue: "2.600.000đ",
    },
    {
      photo:
        "https://i.pinimg.com/736x/6f/f8/d2/6ff8d22732761bd3037a8f27b5faeadc.jpg",
      nameStore: "Mì Quảng",
      quantity: 200,
      revenue: "3.700.000đ",
    },
    {
      photo:
        "https://i.pinimg.com/736x/d5/41/30/d541306e5750a94cc3404cf41765fe6b.jpg",
      nameStore: "Bánh Mì",
      quantity: 150,
      revenue: "3.000.000đ",
    },
    ...
    <div className="min-h-screen max-w-[1200px] my-10 mx-auto sm:p-0 p-4 bg-gray-50">
      <header className="bg-[#F8E7CC] text-white p-4">
        <div className="container mx-auto">
          <h1 className="text-3xl text-[#ff7e00] font-semibold">
      ...
      <div className="container mx-auto p-6">
        ...
        <div className="text-center mt-6">
          <p className="text-lg font-semibold">
            Tổng doanh thu:{" "}
            <span className="text-2xl font-bold">Jack 5 củ</span>
          </p>
        </div>
      </div>
    </div>
