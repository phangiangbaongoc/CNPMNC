...
//       store.items.reduce(
//         (storeTotal, item) =>
//           item.selected ? storeTotal + item.quantity : storeTotal,
//         0
//       ),
//     0
//   );
...
//       store.items.reduce(
//         (storeTotal, item) =>
//           item.selected ? storeTotal + item.price * item.quantity : 0,
//         0
//       ),
//     0
//   );
...
//               <div
//                 key={store.storeId}
//                 className="mt-5 p-4 border rounded-lg shadow-sm bg-gray-50"
//               >
...
//                         onChange={() =>
//                           handleSelectItem(store.storeId, item.id)
//                         }
//                       />
//                       <div>
